...
Singleton {
    ...
    function withAlpha(c: color, isLayered: bool): color {
        if (!transparency.enabled)
            return c;

        c = Qt.rgba(c.r, c.g, c.b, isLayered ? transparency.layers : transparency.base);
    ...
    // Bump the lightness if is a dark color and the inverse
    ...
    component Transparency: QtObject {
        ...
        readonly property real layers: 0.38
    }
    ...
    component M3Palette: QtObject {
        ...
        property color m3outlineVariant: "#565f89"
